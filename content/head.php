...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-145140313-1"></script>
	<script>
  	window.dataLayer = window.dataLayer || [];
  	function gtag(){dataLayer.push(arguments);}
  	gtag('js', new Date());

  	gtag('config', 'UA-145140313-1');
	</script>
	<!-- Fin Code -->
	...
	<!-- Open Graph -->
	<meta property="og:title" content="AgroNexo | Tú negocio, tú decisión" />
	<meta property="og:url" content="http://www.agronexo.cl" />
	...
	<!-- Title &amp; Favicon -->
	<title>AgroNexo | Tú negocio, tú decisión</title>
